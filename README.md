...
Discord のスラッシュコマンド `/uranai` と、パネル形式の `/uranai-panel` で星座占い・おみくじ・花占いを楽しめる Bot です。

## できること

- 12 星座から選んで今日の占いを表示
- パネルのボタンから占いの種類を選び、本人だけに結果を表示
- おみくじで今日の運勢を手軽に確認
- 花を選ぶ花占いで恋や気分の流れを表示
...
- `/uranai`
  星座を直接指定して占いを表示します。
- `/uranai-panel`
  星座占い・おみくじ・花占いの入口パネルをチャンネルに投稿します。最初に説明付きの Embed と 3 つのボタンが表示され、選んだ結果は選択した本人だけに見えます。
